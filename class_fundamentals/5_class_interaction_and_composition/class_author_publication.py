...
class Author:
    ...
    def get_author_summary(self):
        publication_titles = "No titles publised" if len(self.publications) == 0 else [publication.title for publication in self.publications]
...
class Publication:
    ...
    def remove_author(self, author_name): # shouldnt this also work bidirectionally? Have a remove publication method? 
